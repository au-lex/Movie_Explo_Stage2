        ...
        <main>
            ...
            <div className="bannerContainer">
              <section className="pl-[8rem] pt-[10rem]">
                <section className="herotitle w-[40%] ">
                  <h1
                    className="font-sans text-slate-300 font-bold text-[3rem]
                             capitalize"
                  >
                  ...
                  <p className="text-slate-300 text-[15px]">
                    {" "}
                    john wick is on the run after killing a memeber
                    <br />
                  ...
                  <div className="bg-rose-700  capitalize font-bold py-2  w-[30%] flex rounded-[8px] my-4">
                    <span className="text-slate-200 block px-3 pt-1">
              ...
              <section className="pl-[1.3rem] pt-[2rem]">
                <section className="herotitle w-[100%] ">
                  <section className="flex justify-between">
                    <h1
                      className="font-sans text-slate-300 font-bold
                            mt-[6rem] text-[1rem]
                             capitalize z-50"
                    >
                      john wick 3: <br /> parabellum
                    ...
                    <div className="icons flex my-[.6rem] space-x-12 ">
                      <div className="icon1 flex space-x-3 mt-[6rem]">
                        ...
                        <span className="text-slate-300 block z-50">
                          86.0/100
                        </span>
                      </div>
                      <div className="icon2 flex space-x-3">
                  ...
                  <p className="text-slate-300 text-[12px] z-50">
                    {" "}
                    john wick is on the run after killing a memeber
                    <br />
                    of the international assassin's guild, and with <br />
                  ...
                  <div className="bg-rose-700 z-50  capitalize font-bold py-2  w-[50%] flex rounded-[8px] my-4">
                    <span className="text-slate-200 block px-3 pt-1 z-50 ">
                      <BsFillPlayCircleFill />
                    </span>
                    <a href="#" className="text-slate-300 z-50'">
                      Watch trailer
                    </a>
                  </div>
                </section>
          ...
          <section className="cardDisplay lg:hidden md:hidden xl:hidden ">
            <section className="px-[1.2rem] flex justify-between">
              <h2 className="text-[1.8rem] font-semibold my-[3rem]">
                Featured movie
              </h2>
              <div className="flex text-rose-600">
                <h4 className="text-[15px] font-semibold my-[3.5rem] ">
                  See More{" "}
                </h4>
                <span className="block text-[25px] font-semibold my-[3.5rem]">
                  <BiChevronRight />
                </span>
              </div>
            </section>
    ...
    {convertToUTCDate(movie.release_date)}
          ...
          <section className="cardDisplay hidden lg:block md:block xl:block">
            <section className="px-[7.2rem] flex justify-between">
              ...
              <div className="flex text-rose-600">
                <h4 className="text-[15px] font-semibold my-[3rem] ">
                  See More{" "}
                </h4>
                <span className="block text-[25px] font-semibold my-[3rem]">
                  <BiChevronRight />
                </span>
              </div>
            </section>
